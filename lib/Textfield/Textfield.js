  ...
  _createClass(Textfield, [{
    ...
    value: function renderField() {
      ...
      var _props = this.props,
          ...
          value = _props.value,
          otherProps = _objectWithoutProperties(_props, ['className', 'disabled', 'floatingLabel', 'helptext', 'helptextPersistent', 'helptextValidation', 'useInvalidProp', 'invalid', 'id', 'multiline', 'value']);
